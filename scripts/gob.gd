...
@export var min_change_time: float = 0.5 # Minimum time before changing direction
@export var max_change_time: float = 2.0 # Maximum time before changing direction
